...
export function PageShell({ locale, routeKey, dict, children }: PageShellProps) {
  return (
    <div className="crt-scanlines flex min-h-dvh flex-col">
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[70] focus:rounded-lg focus:bg-neon-amber focus:px-4 focus:py-3 focus:font-display focus:text-[0.625rem] focus:uppercase focus:text-void"
      >
